<nav class="w-full bg-white shadow-sm p-4 fixed top-0 right-0" style="width: calc(100% - 16rem);">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex-1 max-w-2xl relative">
            <div class="relative">
                ...
                <input
                    type="text"
                    placeholder="Kamu mau belajar tentang apa..."
                    class="min-w-[100px] max-w-[500px] w-full pl-10 pr-4 py-2 rounded-full border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
            </div>
        </div>
        
        <div class="flex items-center gap-4 ml-4">
            <button class="h-10 w-10 rounded-full border border-gray-500 flex items-center justify-center">
            ...
            <div class="h-16 border-l-4 border-gray-900"></div>
